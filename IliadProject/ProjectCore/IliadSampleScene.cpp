...
void IliadSampleScene::Initialize()
{
	...
	bunny1->AddComponent<ili::ModelComponent>()->SetModel(bunnyModel);
	...
	bunny2->AddComponent<ili::ModelComponent>()->SetModel(bunnyModel);
	...
	vaseObject->AddComponent<ili::ModelComponent>()->SetModel(vase);
