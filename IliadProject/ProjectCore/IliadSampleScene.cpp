...
void IliadSampleScene::Initialize()
{
	...
	//ili::GameObject pointLightComponent = ili::GameObject::MakePointLight(0.2f);
	...
	auto vaseObject = CreateGameObject();
	...
	auto floorObject = CreateGameObject();
